...
var argv = cmdenv('micromono')
  ...
  .option('--host [host]', 'The http host which balancer/service binds to.')
 ...
 */
var Server = module.exports = function MicroMonoServer(options) {
 ...
 * @type {Object}
 */
Server.prototype.getDefaultOptions = function(options) {
  options = options || {}
 ...
 */
Server.prototype.parsePackageInfo = function(packagePath) {
 ...
 */
Server.prototype.require = function(name) {
 ...
 */
Server.prototype.startService = function(ServiceClass) {
 ...
 */
Server.prototype.startBalancer = function(app) {
  var self = this
  ...
  var promise = manager.runServices(framework)
  ...
  return promise
    .then(function() {
      return framework.startServer(PORT, HOST).then(function(server) {
