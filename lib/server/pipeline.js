...
exports.initBalancer = Superpipe.pipeline()
  ...
  .pipe('prepareHealthHandler', ['MICROMONO_HEALTH_PORT', 'MICROMONO_HEALTH_HANDLER'], 'healthHandler')
  .pipe('startHealthinessServer?',
    ['MICROMONO_HOST', 'MICROMONO_HEALTH_PATH', 'MICROMONO_HEALTH_PORT', 'healthHandler'])
