...
exports.initBalancer = superpipe()
  ...
  .pipe('getJSPMConfig?', ['balancerAssetInfo', 'balancerPublicPath', 'next'], ['jspmConfig', 'jspmConfigPath'])
  ...
  .pipe('bundleDevDependencies?',
    ['balancerAssetInfo', 'balancerPublicPath', 'balancerPackagePath', 'jspmBinPath', 'next', 'bundle dev'])
  .pipe('updateJSPMConfig', ['jspmConfigPath', 'jspmConfig', 'balancerAssetInfo', 'next'])
