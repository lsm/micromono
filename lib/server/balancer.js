...
module.exports = function startBalancer(app, opts, callback) {
  ...
  micromono
    ...
    .set('createPipeline', superpipe.pipeline.bind(superpipe))
    ...
    // .set('updateBalancerJSPMBundles',
    //   function updateBalancerJSPMConfig(assetBundles, next) {
    //     var jspmConfig = micromono.get('jspmConfig')
    ...
    .set('errorHandler', function(err, errPipeName, errPipeBody) {
  ...
  balancer(superpipe, 'startBalancer')
}
