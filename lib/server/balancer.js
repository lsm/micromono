...
module.exports = function startBalancer(app, opts, callback) {
  ...
  require('../args/rpc')
  var serverOptions = require('../args/server').parse(process.argv)
  if (serverOptions.serviceDir)
    this.serviceDir = serverOptions.serviceDir
  ...
  superpipe
    ...
    .setDep('serverOptions', serverOptions)
