...
exports.bundleDevDependencies = function(assetInfo, publicPath, packagePath, next) {
  if (assetInfo.dependencies) {
    ...
    exports.bundle(assetInfo, packagePath, bundleInfo.bundleCmd, bundleInfo.bundleOptions, next)
  }
}
