...
exports.bundle = function(assetInfo, packagePath, jspmBinPath, bundleCmd, bundleOptions, next) {
  ...
  jspm.runJSPM(packagePath, jspmBinPath, bundleCmd.split(' '), function(err) {
    ...
    fs.stat(outFileJs, function(err, stats) {
      if (stats && stats.isFile()) {
        ...
        next.setDep('bundleJs', assetInfo.bundleJs)
      } else {
    ...
    fs.stat(outFileCss, function(err, stats) {
      if (stats && stats.isFile()) {
        ...
        next.setDep('bundleCss', assetInfo.bundleCss)
      } else {
...
exports.bundleDevDependencies = function(assetInfo, publicPath, packagePath, jspmBinPath, next) {
  if (assetInfo.dependencies) {
    ...
    exports.bundle(assetInfo, packagePath, jspmBinPath, bundleInfo.bundleCmd, bundleInfo.bundleOptions, next)
  }
}
