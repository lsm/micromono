...
exports.health = [
  ['--health-path [path]', 'Relative url path of the healthiness http request handler', '/__health'],
  ['--health-port [port]', 'Port of the healthiness http server listens. Setting this option will enable the healthiness handler.']
]
