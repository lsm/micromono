...
exports.health = [
  ['--health-port [port]', 'Port of the healthiness http server listens. MICROMONO_HEALTH_PORT. Setting this option will enable the default healthiness handlers.'],
  ['--health-alive-path [path]', 'Relative url path of the liveness http request handler. MICROMONO_HEALTH_ALIVE_PATH', '/__health/alive'],
  ['--health-functional-path [path]', 'Relative url path of the functional (readiness) http request handler. MICROMONO_HEALTH_FUNCTIONAL_PATH', '/__health/functional']
]
