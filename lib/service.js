...
var Service = module.exports = function MicroMonoService() {
  ...
  if (this.packageInfo.jspm) {
    ...
    this.announcement.client.name = this.announcement.name;
    this.asset.pkgInfo.name = this.announcement.name;
  }
  ...
  if (this.upgradeUrl) {
    this.allowUpgrade(this.upgradeUrl);
  }
...
Service.prototype = {
  ...
  allowUpgrade: function(upgradeUrl) {
    if (upgradeUrl === undefined) {
      return this.announcement.allowUpgrade;
    } else if (upgradeUrl) {
      upgradeUrl = path.join(this.baseUrl, upgradeUrl);
    }
    return (this.announcement.allowUpgrade = upgradeUrl);
  },
