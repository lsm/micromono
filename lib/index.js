 ...
 */
var ip = require('ip')
var logger = require('./logger')('micromono')
...
var Micromono = function() {
  ...
  if (micromono.get('MICROMONO_DISCOVERY_AGENT')) {
    ...
    micromono.startService = entrance.startService.bind(null, micromono)
    micromono.startBalancer = entrance.startBalancer.bind(null, micromono)
...
/**
 * Add logger constructor as instance function.
 */
Micromono.prototype.logger = require('./logger')
