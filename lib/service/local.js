...
var logger = require('../logger')('micromono:service:local')
...
exports.getPackageJSON = function(packagePath) {
  ...
  try {
    ...
    logger.info('Failed to load package.json. Use default settings', {
...
exports.prepareFrameworkForLocal = function(framework, set) {
  logger.debug('prepareFrameworkForLocal', {
...
exports.generateAnnouncement = function(service, serviceInfo, host, web, api, channel) {
  ...
  ann.id = crypto.createHash('sha256')
    .update(Date.now() + '')
...
exports.announceService = function(announcement, discoveryAnnounce, discoveryOptions) {
  logger.info('Service starts announcing', {
    service: announcement.name,
    version: announcement.version,
    backend: discoveryOptions.MICROMONO_DISCOVERY_BACKEND
  })
