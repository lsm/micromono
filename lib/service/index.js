...
exports.initLocalServicePipeline = function(micromono, Service) {
  var service
  ...
  var servicePipeline = ServicePipeline.initLocalService.clone(micromono.superpipe)
...
exports.startService = function(micromono, Service, callback, dependencies) {
  var servicePipeline = exports.initLocalServicePipeline(micromono, Service)
